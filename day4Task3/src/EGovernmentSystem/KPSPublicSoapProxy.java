...
public class KPSPublicSoapProxy implements EGovernmentSystem.KPSPublicSoap {
  private String _endpoint = null;
  private EGovernmentSystem.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new EGovernmentSystem.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public EGovernmentSystem.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
