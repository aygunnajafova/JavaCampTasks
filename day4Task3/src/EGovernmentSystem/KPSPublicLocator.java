...
package EGovernmentSystem;

public class KPSPublicLocator extends org.apache.axis.client.Service implements EGovernmentSystem.KPSPublic {
    ...
    public EGovernmentSystem.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public EGovernmentSystem.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            EGovernmentSystem.KPSPublicSoapStub _stub = new EGovernmentSystem.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (EGovernmentSystem.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                EGovernmentSystem.KPSPublicSoapStub _stub = new EGovernmentSystem.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
